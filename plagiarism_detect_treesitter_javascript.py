...
def compare_code_treesitter_javascript(
    ...
    for other in other_students:
        ...
        # Template/skeleton: cap when property/call names differ (toUpperCase vs toLowerCase)
        ...
        if ast_similarity > 0.5 and abs(main_loop_cnt - other_loop_cnt) >= 1 and abs(main_call_cnt - other_call_cnt) >= 1:
