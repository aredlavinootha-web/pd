"""
Run tree-sitter C detector on all batches_c batches and output expected vs actual table.
"""
...
BATCH_DIR = os.path.join(os.path.dirname(__file__), "batches_c")
...
def run_batches():
    ...
    for batch_dir in batches:
        ...
        # Load batch
        sys.path.insert(0, os.path.join(BATCH_DIR, batch_dir))
        try:
        ...
        # Run tree-sitter C
        try:
            result = compare_code_treesitter_c(
                "ref", ref_code,
...
def print_table(rows):
    print()
    print("=" * 90)
    print("Tree-Sitter C — batches_c: Expected vs Actual Similarity")
    print("=" * 90)
    print()
    fmt = "{:<45} {:>12} {:>12} {:>8}"
