"""
Run tree-sitter JavaScript detector on all batches_javascript batches and output expected vs actual table.
"""
...
BATCH_DIR = os.path.join(os.path.dirname(__file__), "batches_javascript")
...
def run_batches():
    ...
    for batch_dir in batches:
        ...
        # Run tree-sitter JavaScript
        try:
            result = compare_code_treesitter_javascript(
                "ref", ref_code,
...
def print_table(rows):
    print()
    print("=" * 90)
    print("Tree-Sitter JavaScript — batches_javascript: Expected vs Actual Similarity")
    print("=" * 90)
    print()
    fmt = "{:<45} {:>12} {:>12} {:>8}"
