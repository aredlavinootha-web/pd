...
def compare_code_treesitter_java(
    ...
    for other in other_students:
        ...
        if main_methods and other_methods and main_methods != other_methods and ast_similarity > 0.95:
        ...
        if main_loops and other_loops and main_loops != other_loops and ast_similarity > 0.75:
        ...
        if ast_similarity > 0.5 and abs(main_loop_cnt - other_loop_cnt) >= 1 and abs(main_method_cnt - other_method_cnt) >= 1:
