"""
Run tree-sitter C# detector on all batches_csharp batches and output expected vs actual table.
"""
...
BATCH_DIR = os.path.join(os.path.dirname(__file__), "batches_csharp")
...
def run_batches():
    ...
    for batch_dir in batches:
        ...
        # Run tree-sitter C#
        try:
            result = compare_code_treesitter_csharp(
                "ref", ref_code,
...
def print_table(rows):
    print()
    print("=" * 90)
    print("Tree-Sitter C# — batches_csharp: Expected vs Actual Similarity")
    print("=" * 90)
    print()
    fmt = "{:<45} {:>12} {:>12} {:>8}"
