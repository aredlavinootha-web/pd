"""
Run tree-sitter Java detector on all batches_java batches and output expected vs actual table.
"""
...
BATCH_DIR = os.path.join(os.path.dirname(__file__), "batches_java")
...
def run_batches():
    ...
    for batch_dir in batches:
        ...
        # Run tree-sitter Java
        try:
            result = compare_code_treesitter_java(
                "ref", ref_code,
...
def print_table(rows):
    print()
    print("=" * 90)
    print("Tree-Sitter Java — batches_java: Expected vs Actual Similarity")
    print("=" * 90)
    print()
    fmt = "{:<45} {:>12} {:>12} {:>8}"
